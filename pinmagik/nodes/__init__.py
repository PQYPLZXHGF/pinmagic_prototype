...
class SevenSegmentEncoderNode(Node):
    ...
    def do_calculations(self, dock, val=None):
        ...
        self.res_ul.set_value( num in (0x0,0x4,0x5,0x6,0x8,0x9,0xA,0xB,0xC,0xE,0xF))
    ...
    %(res_ul)s = v%(node_id)s_number in (0x0,0x4,0x5,0x6,0x8,0x9,0xA,0xB,0xC,0xE,0xF)
    ...
    %(res_ll)s = v%(node_id)s_number in (0x0,0x2,0x6,0x8,0xA,0xB,0xC,0xD,0xE,0xF)
    %(res_lr)s = v%(node_id)s_number in (0x0,0x1,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xA,0xB,0xD)
    %(res_l)s = v%(node_id)s_number in (0x0,0x2,0x3,0x5,0x6,0x8,0x9,0xB,0xC,0xD,0xE)
        """%{
                "node_id" : id(self),
